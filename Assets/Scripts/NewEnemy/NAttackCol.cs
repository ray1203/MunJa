...
public class NAttackCol : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D col)
    {
        ...
        if (col.CompareTag("Player"))
        {
            ...
            transform.parent.GetComponent<Rigidbody2D>().AddForce(dir2 * 50f);
        ...
        else if (col.CompareTag("arrow"))
        {
            ...
            transform.parent.GetComponent<NEnemyController>().hp -= col.GetComponent<Arrow>().damage;
        ...
        else if (col.CompareTag("swordEffect"))
        {
            ...
            transform.parent.GetComponent<NEnemyController>().hp -= col.GetComponent<SwordEffect>().damage;
        }
    }
